...
def test_admion_payout_seller(admin_client, seller_client, buyer_client, usdc) -> None:
    amount = int(1e10)
    order_id = "payout_3_usdc"
    ...
    # Admin refund tokens to buyer addr
    r_refund = admin_client.call(
        Ecommerce.adminPayoutSeller,
        k=order_id,
    ...
    print(f"Admin payout seller: {r_refund.return_value}")
    print(f"Seller withdraw usdc: {r_withdraw.return_value}")
